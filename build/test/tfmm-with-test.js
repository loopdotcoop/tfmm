...
(function() {
  var Asset, AssetManager, Flourish, Maestro, Main, Tudor, Voice, VoiceSet, tudor, ª, ªA, ªB, ªE, ªF, ªI, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªclone, ªex, ªhas, ªpopulate, ªredefine, ªretrieve, ªtype, ªuid,
  ...
  Flourish = (function() {
    ...
    Flourish.prototype.render = function(frame, context, size) {
      var now, pos, scale, thing;
      now = frame.frac2000;
  ...
  Voice = (function() {
    ...
    Voice.prototype.render = function(frame, vSize) {
      var flourish, j, len, ref, results, scaleMultiplier;
      this.now = frame;
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        flourish = ref[j];
        results.push(flourish.render(frame, this.visualizer, vSize));
      }
      return results;
    };
