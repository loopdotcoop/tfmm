...
/*! Tfmm 0.0.8 //// MIT Licence //// http://tfmm.loop.coop/ */

(function() {
  var Asset, AssetManager, Flourish, Maestro, Main, Timeline, Tudor, Voice, VoiceSet, tudor, ª, ªA, ªB, ªE, ªF, ªI, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªclone, ªex, ªhas, ªpopulate, ªredefine, ªretrieve, ªtype, ªuid,
  ...
  Asset = (function() {
    ...
    Asset.prototype.load = function() {
      ...
      setTimeout(((function(_this) {
        return function() {
          _this.progress = Math.random() * 0.5;
          return _this.manager.progressHandler();
        };
      })(this)), Math.random() * 1000);
      setTimeout(((function(_this) {
        return function() {
          _this.progress = Math.random() * 0.5 + 0.5;
          return _this.manager.progressHandler();
        };
      })(this)), 1000 + (Math.random() * 1000));
      setTimeout(((function(_this) {
        return function() {
          _this.state = 'complete';
          _this.progress = 1;
          _this.manager.progressHandler();
          return _this.manager.completeHandler();
        };
      })(this)), 2000 + (Math.random() * 1000));
      return 1;
    };
  ...
  tudor.add([
    "02 Asset and AssetManager Usage", "The classes and instances are expected types", tudor.is, "The Asset class is a function", ªF, function() {
      ...
      return new Asset;
    }, "Asset instance has expected enumerable properties", 'setManager,state,progress,manager,url,C,toString,load', function(mock) {
      var prop;
      return ((function() {
        var results;
        results = [];
      ...
      return new AssetManager;
    }, "AssetManager instance has expected enumerable properties", 'progress,assets,onProgress,onComplete,C,toString,add,load,progressHandler,completeHandler', function(mock) {
      var prop;
      return ((function() {
        var results;
        results = [];
    ...
    }, "First call to `load()` reports that two Assets started loading", 2, function(mock) {
      return mock.load();
    }, "After `load()`, both Assets’ states are 'loading'", 'loading,loading', function(mock) {
      var asset;
      return ((function() {
        var j, len, ref, results;
        ref = mock.assets;
    ...
    }, "Second call to `load()` reports that no Assets have started loading", 0, function(mock) {
      return mock.load();
    }
  ]);
