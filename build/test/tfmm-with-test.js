...
/*! Tfmm 0.1.0 //// MIT Licence //// http://tfmm.loop.coop/ */

(function() {
  var $, $$, Asset, AssetManager, Blot, Flourish, Maestro, Main, MicIn, Tudor, Voice, VoiceSet, col, i, keyCode, ref, ref1, row, tudor, vpSize, ª, ªA, ªB, ªE, ªF, ªI, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªclone, ªex, ªhas, ªkeymaps, ªpopulate, ªredefine, ªretrieve, ªtype, ªuid,
  ...
  ref = ªkeymaps.qwerty.k2l;
  for (keyCode in ref) {
    ref1 = ref[keyCode], col = ref1[0], row = ref1[1], i = ref1[2];
  ...
  Maestro = (function() {
    ...
    Maestro.prototype.step = function(stamp) {
      var cue, currFlip2000, flip2000, flip8000, fn1, j, len, ref2, renderer;
  ...
  Main = (function() {
        ...
        for (j = 0, len = ref2.length; j < len; j++) {
          ...
          results.push((function(_this) {
            return function($voiceSet) {
              var fn1, front, k, l, len1, ref3, ref4, v;
              front = {};
              ref3 = _this.arts[$voiceSet.id].front;
              fn1 = function(k, v) {
                return front[k] = v;
              };
              for (l = 0, len1 = ref3.length; l < len1; l++) {
                ref4 = ref3[l], k = ref4[0], v = ref4[1];
                fn1(k, v);
              }
    ...
    Main.prototype.initAssetManager = function() {
      var assetManager, j, l, len, len1, ref2, ref3, voice, voiceSet;
    ...
    Main.prototype.enableUserInput = function() {
      var $voiceSet, e, j, len, micIn, ref2, results;
      try {
        micIn = new MicIn({
      ...
      window.addEventListener('keydown', (function(_this) {
        return function(event) {
          var allVoicesIndex, ref2, ref3, ref4;
          if (49 <= event.keyCode && 57 >= event.keyCode) {
            _this.simulateClick((ref2 = _this.voiceSets[event.keyCode - 48 - 1]) != null ? ref2.$canvas : void 0);
          }
          if (97 <= event.keyCode && 105 >= event.keyCode) {
            _this.simulateClick((ref3 = _this.voiceSets[event.keyCode - 96 - 1]) != null ? ref3.$canvas : void 0);
          }
          allVoicesIndex = (ref4 = ªkeymaps.qwerty.k2l[event.keyCode]) != null ? ref4[2] : void 0;
    ...
    Main.prototype.updater = function(current) {
      var $element, className, digits, j, len, match, ref2, voiceSet;
      this.active = null;
      ...
      digits = match ? match[2] : '';
      document.body.className = document.body.className.replace(/act-\d*/g, 'act-' + digits);
      return ª(current);
    };
  ...
  Voice = (function() {
    ...
    function Voice(config) {
      ...
      this.$label.setAttribute('style', 'color: ' + this.color);
      this.$label.innerHTML = ªkeymaps.qwerty.i2c[config.allVoices.length];
      config.$voiceSet.appendChild(this.$label);
      ...
      this.icon.fillStyle = config.color;
    ...
    Voice.prototype.render = function(frame, visSize) {
      var flourish, j, len, ref2, results, time;
      this.now = frame;
  ...
  VoiceSet = (function() {
    ...
    function VoiceSet(config) {
      ...
      this.$voiceSet = config.$voiceSet;
      this.$canvas = document.createElement('canvas');
      this.$canvas.setAttribute('width', this.size + 'px');
      this.$canvas.setAttribute('height', this.size + 'px');
      this.$canvas.setAttribute('class', 'visualizer');
      this.$voiceSet.appendChild(this.$canvas);
    ...
    VoiceSet.prototype.activate = function() {
      var h, j, len, ref2, ref3, results, voice, w;
      ref2 = vpSize(), w = ref2[0], h = ref2[1];
      this.size = (Math.min(w, h)) - 20;
      ª(w, h, this.size);
      this.size = 512;
      this.$canvas.setAttribute('width', this.size + 'px');
      this.$canvas.setAttribute('height', this.size + 'px');
    ...
    VoiceSet.prototype.render = function(frame) {
      var j, l, len, len1, len2, m, ref2, ref3, ref4, voice;
      if (frame.flip2000) {
        ref2 = this.voices;
        for (j = 0, len = ref2.length; j < len; j++) {
          voice = ref2[j];
  ...
  Tudor = (function() {
    ...
    Tudor.prototype.add = function(lines) {
      var article, line, runner, section;
      article = {
        sections: []
      };
      runner = null;
    ...
    Tudor.prototype["do"] = function() {
      var actual, art, artFail, artPass, article, e, error, expect, heading, j, job, l, len, len1, len2, m, mock, pge, pgeFail, pgePass, ref2, ref3, ref4, result, runner, sec, secFail, secPass, section, summary;
      pge = [];
      mock = null;
      pgePass = pgeFail = 0;
      ref2 = this.articles;
    ...
    Tudor.prototype.isAssertion = function(line1, line2) {
      ...
      if ((ªO === ��type(line1)) && ªF === ªtype(line1.runner)) {
        return false;
      }
      return true;
    };
