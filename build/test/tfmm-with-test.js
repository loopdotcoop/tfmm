...
(function() {
  ...
  Flourish = (function() {
    ...
    Flourish.prototype.lookahead = function(now, frame) {
      ...
      return this.voice.play(frame.stamp + (this.start - now) * 2000);
    };
  ...
  Timeline = (function() {
    ...
    Timeline.prototype.render = function(frame, context, size) {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        flourish = ref[j];
        results.push(flourish.render(frame, context, size));
      }
      return results;
    };
  ...
  Voice = (function() {
    ...
    Voice.prototype.play = function(velocity, stamp) {
      ...
      source.connect(this.maestro.audioCtx.destination);
      return source.start(stamp);
    };
