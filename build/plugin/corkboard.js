...
(function() {
  var $player, $ref, art, currentTfmm, fn, fn1, i, j, l, len, len1, len2, prevFlip2000, ref, ref1, step, tfmms;
  ...
  window.addEventListener('keydown', function(event) {
    if (81 === event.keyCode) {
      return typeof currentTfmm !== "undefined" && currentTfmm !== null ? currentTfmm.trigger(1) : void 0;
    }
  });
  ...
  step = function(stamp) {
    var currFlip2000, flip2000, flip8000, fn2, frame, len3, m, tfmm;
