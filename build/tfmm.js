...
(function() {
  var $, $$, Asset, AssetManager, Blot, Flourish, Maestro, Main, MicIn, Voice, VoiceSet, col, i, keyCode, ref, ref1, row, vpSize, ª, ªA, ªB, ªE, ªF, ªI, ªN, ªO, ªR, ªS, ªU, ªV, ªX, ªclone, ªex, ªhas, ªkeymaps, ªpopulate, ªredefine, ªretrieve, ªtype, ªuid,
  ...
  Maestro = (function() {
    ...
    Maestro.prototype.step = function(stamp) {
      var cue, currFlip2000, flip2000, flip8000, fn, j, len, ref2, renderer;
        ...
        for (j = 0, len = ref2.length; j < len; j++) {
          ...
          results.push((function(_this) {
            return function($voiceSet) {
              var fn, front, k, l, len1, ref3, ref4, v;
              front = {};
